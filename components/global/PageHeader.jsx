  ...
  return (
    <div className="py-2 px-5  bg-primary rounded-[15px] mt-5">
      <div className="flex items-center justify-between">
        <h1 className="text-white font-cabin font-semibold  text-3xl">{title}</h1>
        <div className="flex items-center gap-x-2">
          <button className="bg-white rounded-full md:w-11 md:h-11 w-11 h-11 flex items-center justify-center cursor-pointer">
