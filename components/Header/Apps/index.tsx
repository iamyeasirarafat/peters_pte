...
const Apps = ({}: AppsProps) => {
  return (
    <Menu className="relative mr-7 md:hidden" as="div">
      ...
      >
        <Menu.Items className="absolute top-full -right-[9.8rem] w-[24.25rem] mt-2.5 border border-n-1 rounded-sm bg-white shadow-primary-4 dark:bg-white/20 dark:border-white">
