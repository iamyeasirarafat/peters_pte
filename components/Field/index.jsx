      ...
      <div className="">
        ...
        <div className="relative">
          {textarea ? (
            <textarea
              className={twMerge(
                `w-full h-24 px-5 py-3 bg-white border-none   rounded-sm text-sm text-n-1 font-bold outline-none resize-none transition-colors placeholder:text-n-3 focus:border-primary dark:bg-white/20  dark:text-white dark:focus:border-primary dark:placeholder:text-white/75 ${icon ? "pr-15" : ""
            ...
            <input
              className={twMerge(
                `w-full h-16 px-5 bg-white border-none  rounded-sm text-sm text-n-1 font-bold outline-none transition-colors placeholder:text-n-3 focus:border-primary dark:bg-white/20  dark:text-white dark:focus:border-primary dark:placeholder:text-white/75 ${icon || type === "password" ? "pr-15" : ""
                } ${success ? "pr-15 !border-green-1" : ""} ${error ? "pr-15 !border-pink-1" : ""
                } ${image || currency ? "pr-15" : ""} ${classInput}`
              )}
              type={
