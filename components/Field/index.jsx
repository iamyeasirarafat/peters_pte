      ...
      <div className="">
        ...
        <div className="relative">
          {textarea ? (
            <textarea
              className={twMerge(
                `w-full h-24 px-5 py-3 bg-white border-none   rounded-sm text-sm text-n-1 font-bold outline-none resize-none transition-colors placeholder:text-n-3 focus:border-primary dark:bg-white/20  dark:text-white dark:focus:border-primary dark:placeholder:text-white/75 ${
                  icon ? "pr-15" : ""
