...
const LineProgressWidget = ({ data }) => {
    ...
    return (
        <div className="w-full md:w-auto flex flex-col items-start px-5 py-3 md:px-3 lg:py-3 lg:px-5 md:py-3 gap-2 capitalize border border-[#CF8800] rounded-[10px]">
            <p>{title}</p>
            <span style={{ color: color }} className={`text-3xl font-semibold`}>{value}</span>
            {/* line progress bar */}
