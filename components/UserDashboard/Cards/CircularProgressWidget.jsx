...
const CircularProgressWidget = ({ data }) => {
    ...
    return data ? <div style={{ borderColor: strokeColor }} className={`flex justify-between items-center py-2 px-3 w-[228px] min-h-[74px] gap-2 capitalize border border-[${strokeColor}] rounded-[10px]`}>
        <div className=" flex flex-col justify-between h-full  w-[70%]">
            <p className={`text-[#949494] leading-[16px] text-[16px] font-normal`}>{title}</p>
