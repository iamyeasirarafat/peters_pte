...
const CircularProgressWidget = ({ data }) => {
    ...
    return data ? <div style={{ borderColor: strokeColor }} className={`flex justify-between items-center py-2 px-3 w-full md:w-auto min-h-[74px] gap-2 capitalize border border-[${strokeColor}] rounded-[10px]`}>
