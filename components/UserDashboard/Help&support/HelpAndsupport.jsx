  ...
  return (
    <div className='my-5'>
      ...
      <div className="flex gap-2 w-full  justify-between ">
        ...
        {/* card 2 */}
        <div className="bg-[url('/images/review.png')] bg-cover w-full min-h-[130px] flex flex-col justify-center items-start gap-2 rounded-[15px] px-5 py-3 ">
          <h3 className="text-4xl font-normal text-white capitalize">Write a Review</h3>
          <div className="w-full px-4 flex items-center rounded-[30px]  overflow-hidden bg-white text-[#CF8800] border border-[#CF8800]">
            <input className="w-[100%] border-0 focus:outline-none focus:ring-0" placeholder="Write Your Review" />
