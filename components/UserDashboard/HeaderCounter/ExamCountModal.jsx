      ...
      <div className="bg-white border border-primary rounded-[15px] w-[1100px] overflow-hidden">
        ...
        <div className="flex flex-col gap-5 p-5">
          <div className="flex gap-5">
            ...
            {/* Time count */}
            <div className="w-1/2 h-16 border border-[#F2B277] bg-[#FFF4EB] p-2 rounded-[10px]">
              <p className="text-[36px] text-[#616161] bg-white justify-between text-center rounded-[10px] p-3">
                20d 03h 03m 52s
              </p>
            </div>
          </div>
