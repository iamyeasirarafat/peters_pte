...
const mocktest = [
  {
    ...
    icon: "MT",
    Items: "3157",
    url: "/admin/mocktest/full_mocktest",
  },
  {
    id: 2,
    ...
    icon: "SMT",
    Items: "3157",
    url: "/admin/mocktest/speaking_mocktest",
  },
  {
    id: 3,
    ...
    icon: "LMT",
    Items: "3157",
    url: "/admin/mocktest/listening_mocktest",
  },
  {
    id: 4,
    ...
    icon: "WMT",
    Items: "3157",
    url: "/admin/mocktest/writing_mocktest",
  },
  {
    id: 5,
    ...
    icon: "RMT",
    Items: "3157",
    url: "/admin/mocktest/reading_mocktest",
  },
];
const Index = () => {
  return (
