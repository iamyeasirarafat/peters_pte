...
const MockTestForm = () => {
  ...
  const [qustionList, setQuestionList] = React.useState([
    ...
    { id: 5, name: "Answer Short Question", questionType: "answer_short_question" },
    ...
    { id: 12, name: "Record Missing Words", questionType: "record_missing_words" },
    { id: 13, name: "Multiple Choice Single", questionType: "multiple_choice_single" },
    { id: 14, name: "Highlight Correct Summary", questionType: "highlight_correct_summary" },
    { id: 15, name: "Highlight Incorrect Words", questionType: "highlight_incorrect_words" },
  ])
  ...
  return (
    <>
      ...
      <MockTestLayout handleNext={handleNext} handlePrev={handlePrev} handleFinish={handleFinish} progress={progress} isLastQuestion={isLastQuestion}>
      ...
      {
        submitModal && <SubmitModal open={submitModal} setOpen={setSubmitModal} />
      }
    </>
  )
}
...
const MockTestStartingPage = ({ handleStart }) => {
  return (
    <div className="flex flex-col m-5">
      <h2 className="text-2xl font-medium text-gray-800 mb-4">Score Test D (2 hour)</h2>
      ...
      <div className=" flex justify-center">
        <button onClick={handleStart} className="text-center bg-cyan-700 hover:bg-cyan-800 flex items-center gap-2 text-white px-6 py-2 rounded">Start</button>
      </div>
    </div>
  );
    ...
    <ReusableModal open={open} setOpen={setOpen} className="w-full" >
      ...
      <div className="bg-white shadow-md w-[400px] p-4 rounded-md">
        ...
        <div className="text-left  text-gray text-sm">
          All qustions have been attempted. Do you want to submit the activity now?
        </div>
        ...
        <div className="flex  gap-2 ">
          ...
          <button className="bg-cyan-700 hover:bg-cyan-800 flex items-center gap-2 text-white px-4 py-2 rounded">
            Yes
          </button>
        </div>
      </div>
